...
const Aboutspeaker = ({classevn,bgcolor,miccolor}) => {
...
<div className='grid p-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center items-center gap-5 lg:p-0' >
    ...
    <div className='flex'>
    <i className={`fa-solid fa-microphone-lines py-3 px-4 text-[${miccolor}] group-hover:text-[#FF9822] bg-[${bgcolor}] text-4xl duration-300`}></i>
